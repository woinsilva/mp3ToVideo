...
export class ChildrenClipAssetsController {
  ...
  @Post('reset')
  reset(@CurrentUser() user: AuthenticatedUser, @Param('projectId') projectId: string) {
    return this.assets.resetAndRegenerate(projectId, user.organizationId, user.userId);
  }

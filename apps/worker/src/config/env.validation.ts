...
export const envValidationSchema = Joi.object({
  ...
  COMFYUI_STEPS: Joi.number().integer().positive().default(8),
  COMFYUI_CFG: Joi.number().positive().default(1.8),
  COMFYUI_SAMPLER: Joi.string().default('euler'),
  COMFYUI_SCHEDULER: Joi.string().default('normal'),
